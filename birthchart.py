                ...
                <div style="background: linear-gradient(45deg, {sentiment_color}20, {sentiment_color}10); border: 3px solid {sentiment_color}; border-radius: 15px; padding: 20px; margin: 20px 0; text-align: center;">
                    ...
                    <p style="margin: 10px 0 0 0; font-size: 1.1em; color: {sentiment_color};">
                        <strong>Overall Strategy:</strong> {
                            f'Strong accumulation recommended for {analysis_target} sector stocks' if 'STRONG BULLISH' in sector_sentiment
                            else f'Good buying opportunities in {analysis_target} sector' if 'BULLISH' in sector_sentiment
                            else f'Defensive approach recommended for {analysis_target} sector' if sector_sentiment == 'BEARISH'
                            else f'Selective stock picking in {analysis_target} sector'
                        }
                    </p>
                </div>
                """, unsafe_allow_html=True)
